...
function GlassPanel({ position, rotation = [0, 0, 0], size, color, accent, delay = 0 }: PanelProps) {
...
function DriftingLights() {
  ...
  return (
    <>
      ...
      <pointLight ref={purple} color="#b07cff" intensity={35} distance={10} position={[-2, -1, 2]} />
    ...
    <>
      ...
      <CursorParallax>
        <Float speed={1.2} rotationIntensity={0.15} floatIntensity={0.4}>
          <GlassPanel position={[0, 0, 0]} size={[3.2, 1.9, 0.08]} color="#1a1f3a" accent="#6effc0" />
        </Float>
        <Float speed={1.5} rotationIntensity={0.2} floatIntensity={0.5}>
          <GlassPanel position={[-2.1, 0.6, 0.8]} rotation={[0, 0.25, 0.05]} size={[1.6, 1.1, 0.06]} color="#2a1f3a" accent="#b07cff" delay={1} />
        </Float>
        <Float speed={1.1} rotationIntensity={0.18} floatIntensity={0.45}>
          <GlassPanel position={[2.2, -0.7, 0.6]} rotation={[0, -0.22, -0.04]} size={[1.4, 1.4, 0.06]} color="#152030" accent="#6effc0" delay={2} />
        </Float>
        <Float speed={1.3} rotationIntensity={0.12} floatIntensity={0.35}>
          <GlassPanel position={[1.4, 1.0, 1.2]} rotation={[0, -0.15, 0.03]} size={[1.0, 0.7, 0.05]} color="#1a2540" delay={0.5} />
        </Float>
        <Float speed={1.4} rotationIntensity={0.1} floatIntensity={0.3}>
          <GlassPanel position={[-1.3, -0.9, 1.1]} rotation={[0, 0.18, -0.05]} size={[0.9, 0.6, 0.05]} color="#251a3a" delay={1.5} />
        </Float>
      </CursorParallax>
